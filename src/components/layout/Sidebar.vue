<template>
  <aside class="sidebar">
    ...
    <div class="contact-info">
      <p class="contact-title">{{ t('sections.find') }}</p>
...
const navs = useLocaleData('sections', 'navs')
const contacts = useLocaleData('sections', 'contacts')

const emit = defineEmits(['scrollToSection'])
const { scrollToSection } = useScroll(navs)
